                                                  ...
                                                  unsigned int data_format)
{
  ...
  if (tensor_dims.size() != 4) std::cout<<"dims mismatch."<<std::endl;
  if (tensor_dims.at(0) != 1) std::cout<<"batch != 1"<<std::endl;
  ...
  if (data_format == transform::CHW)
  {
    ...
    if (target_channel != channels) std::cout<<"channel mismatch."<<std::endl;
